...
import {checkIcon} from '@app/components/CategorySlider/views/mobile';
...
import styles from '@app/components/PageBuilder/atoms/WidgetSliderCategory/views/mobile/styles';
