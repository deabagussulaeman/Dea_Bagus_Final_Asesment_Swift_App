...
import styles from '@app/components/BrandSlider/views/mobile/styles';
...
const BrandSliderView = ({brands, loading, onNavigateToProductList}) => {
  ...
  return (
    <Section height={140} horizontalCenter verticalCenter>
      <Section row spaceBetween width={Mixins.MAX_WIDTH} paddingHorizontal={10}>
