...
import styles from '@root/_src/core/components/NavBar/atoms/NavBarCustom/views/tablet/styles';
...
const NavBarCustom = ({
  ...
  return (
    <Appbar.Header>
      ...
      {childrenRight && (
        <Section style={[styles.frameRightChildren, childrenRightStyle]}>
          {childrenRight}
        </Section>
      )}
    </Appbar.Header>
...
NavBarCustom.propTypes = {
  ...
  // children right styling
  childrenRightStyle: PropTypes.any,
  // app content title
