...
import styles from '@app/_modules/account_myreturn/views/tablet/styles';
import {modules} from '@root/swift.config';
import {TYPE_APPBAR} from '@app/helpers/Constants';

const AccountMyReturnTabletView = ({
  t,
  customerReturns,
  loading,
  onLoadMore,
  ...
  const ReturnsItem = ({item, index}) => {
    ...
    return (
      <Section
        ...
        paddingVertical={10}
        height={100}
        style={[{backgroundColor, alignSelf: 'center'}]}>
...
AccountMyReturnTabletView.propTypes = {
...
export default AccountMyReturnTabletView;
