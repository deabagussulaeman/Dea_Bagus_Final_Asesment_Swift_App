...
import styles from '@app/_modules/account_update_information/views/tablet/styles';
...
const AccountUpdateInformationTabletView = ({
  t,
  loading,
  formSchema,
...
AccountUpdateInformationTabletView.propTypes = {
...
export default AccountUpdateInformationTabletView;
