...
import styles from '@app/_modules/blog_detail/views/mobile/styles';
import {TYPE_NAVBAR_CUSTOM} from '@app/helpers/Constants';

const BlogDetailMobileView = ({blogDetail, blogLoading}) => {
      ...
      return (
        <ScrollView>
          ...
          <Section horizontalStart marginVertical={10}>
            <Section row spaceBetween width={Mixins.MAX_WIDTH}>
...
BlogDetailMobileView.propTypes = {
...
export default BlogDetailMobileView;
