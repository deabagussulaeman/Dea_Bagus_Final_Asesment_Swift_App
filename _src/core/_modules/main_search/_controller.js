...
import {SEARCH_PRODUCTS} from '@root/_src/core/components/NavBar/atoms/AddonSearchBar/services/schema';
import useCustomQuery from '@app/hooks/useCustomQuery';
import Views from '@app/_modules/main_search/views';
...
const MainSearchController = props => {
  /**
   * ---------------------------------------------------- *
   * @constant {hooks}
   * ---------------------------------------------------- *
...
export default MainSearchController;
