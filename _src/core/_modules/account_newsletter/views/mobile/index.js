...
const NewsletterMobileView = ({t, loading, onSubmit, isSubscribed}) => {
  ...
  return (
    <>
      ...
      <Section padding={20}>
        ...
        <Show when={!loading}>
          <Label large>{subscriptionStatusMessage}</Label>
        </Show>
        <Button
          mode="contained"
          style={{
...
NewsletterMobileView.propTypes = {
...
export default NewsletterMobileView;
