...
import styles from '@app/_modules/product_detail/atoms/ProductDetailBlock/views/mobile/styles';
...
const ProductDetailBlock = ({
  ...
  return (
    <>
      ...
      <Section flex marginHorizontal={0} style={styles.headerContainer}>
        <ProductReview
          product={product}
