...
import styles from '@app/_modules/account_purchases_detail/views/mobile/styles';
...
const AccountPurchasesDetailMobileView = ({
  t,
  item,
  onRequestReturn,
  rmaFormData,
...
AccountPurchasesDetailMobileView.propTypes = {
...
export default AccountPurchasesDetailMobileView;
