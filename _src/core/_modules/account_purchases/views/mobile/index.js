...
import styles from '@app/_modules/account_purchases/views/mobile/styles';
import {TYPE_APPBAR} from '@app/helpers/Constants';

const AccountPurchasesMobileView = ({
  t,
  onNavigateToPdp,
  customerOrders,
  loading,
...
AccountPurchasesMobileView.propTypes = {
...
export default AccountPurchasesMobileView;
