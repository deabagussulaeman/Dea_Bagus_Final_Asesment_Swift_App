...
import styles from '@app/_modules/product_list/views/tablet/styles';
    ...
    if (mount.current) {
      return (
        <Section>
          ...
          <Section height={30} horizontalCenter verticalCenter marginTop={30}>
            <Label center>
      ...
      <>
        ...
        <Show when={useSliderBanner ?? true}>
          <Section horizontalCenter>
            <Section horizontalCenter marginVertical={40}>
              <Shimmer
                wrapperStyle={{
                  height: 180,
                  alignItems: 'center',
        ...
        <Section horizontalCenter>
          <Section
            ...
            <Shimmer
              wrapperStyle={{
                height: 200,
                width: Mixins.MAX_WIDTH * 0.75 * 0.5 - 5,
                flex: 1,
              }}
            />
            <Shimmer
...
ProductListTabletView.propTypes = {
...
export default ProductListTabletView;
