...
export const accountMenu = [
  ...
  },
  {
    ...
    icon: 'corner-up-left',
    show: modules.account_product_review.enable,
    navigation: () =>
      navigateTo(
        modules.account_product_review.enable,
        modules.account_product_review.name,
      ),
  },
  {
    label: 'Notifications',
  ...
  },
  {
    label: 'Newsletter',
    icon: 'mail',
    show: modules.account_newsletter.enable,
    navigation: () =>
      navigateTo(
        modules.account_newsletter.enable,
        modules.account_newsletter.name,
      ),
  },
  {
