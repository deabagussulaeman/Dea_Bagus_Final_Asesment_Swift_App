...
import styles from '@app/_modules/main_categories/views/mobile/styles';
...
const MainCategoriesMobileView = ({
  t,
  loading,
...
MainCategoriesMobileView.propTypes = {
...
export default MainCategoriesMobileView;
