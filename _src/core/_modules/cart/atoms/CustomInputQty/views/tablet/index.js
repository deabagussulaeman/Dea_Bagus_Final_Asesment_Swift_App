...
import styles from '@app/_modules/cart/atoms/CustomInputQty/views/tablet/styles';
      ...
      return (
        <Section style={styles.customInputQty}>
          <Section
            ...
            <Icon name="minuscircleo" size={normalize(13)} color={color} />
          </Section>
          <TextInput
          ...
          <Section
            ...
            <Icon name="pluscircleo" size={normalize(13)} color={color} />
          </Section>
        </Section>
      );
  }
