...
import styles from '@app/_modules/cart/views/tablet/styles';
          ...
          <Section
            ...
            {modules.cart.atoms.update_item_qty_modal.enable && (
              <ModalUpdateCartItem
                ...
                <SimpleLineIcons name="pencil" size={normalize(10)} />
              </ModalUpdateCartItem>
            )}
            ...
            <ButtonRemoveItemFromCart
              item={item}
              cartItemId={id}
              propStyle={[styles.cartItemActionIcon, {marginLeft: 40}]}
              product={{
                currency:
              ...
              <SimpleLineIcons name="trash" size={normalize(10)} />
            </ButtonRemoveItemFromCart>
          </Section>
        </Section>
      </Section>
