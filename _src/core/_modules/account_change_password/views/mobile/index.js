...
import styles from '@app/_modules/account_change_password/views/mobile/styles';
 ...
 * @returns Components
 */
const ChangePasswordMobileView = ({t, loading, changePassword}) => {
  return (
    <SafeAreaView>
      <NavBar
        type={TYPE_APPBAR}
...
ChangePasswordMobileView.propTypes = {
...
export default ChangePasswordMobileView;
